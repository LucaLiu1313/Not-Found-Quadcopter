...
void MyI2C_Init()
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8 | GPIO_Pin_9;	//将PB8和PB9引脚初始化为复用开漏输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Medium_Speed;
	//GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
	GPIO_Init(GPIOB, &GPIO_InitStructure);
	//GPIO_SetBits(GPIOB, GPIO_Pin_8 | GPIO_Pin_9);			//PB8和PB9默认为高电平（释放总线状态)
...
void MPU6050_Init(void)
{
	...
	MPU6050_WriteReg(MPU6050_USER_CTRL	,0x20);				//使能I2C 主模式
}
